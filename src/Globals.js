...
export const CATEGORIES_CAMELCASE =
  [CURRENTLY_READING_CAMELCASE,
    WANT_TO_READ_CAMELCASE,
    READ_CAMELCASE];

export const MAP_CAMELCASE_TO_NORMAL = {};
CATEGORIES_CAMELCASE.forEach((item, index) => {
  MAP_CAMELCASE_TO_NORMAL[item] = CATEGORIES[index];
});
MAP_CAMELCASE_TO_NORMAL.none = '';

export const MAP_NORMAL_TO_CAMELCASE = {};
